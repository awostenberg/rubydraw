module Rubydraw
  ...
  class Window
    ...
    def clear
      ...
      #fill_with(@bkg_color)
      # new code
      @damaged_regions.each {|rect|
        surf = Surface.new(rect.dimensions, @bkg_color)
        surf.blit(self, rect.position, false)
      }
    end

    # Fill the entire window with a Rubydraw::Color. Do this by feeding SDL the numeric
    # version of the color; see Rubydraw::Color#to_i
    def fill_with(color)
